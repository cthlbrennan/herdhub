...
Alternatively, use this link: https://github.com/cthlbrennan/herdhub/issues
...
[![GitHub issue custom search](https://img.shields.io/github/issues-search?query=repo%3Acthlbrennan%2Fherdhub%20label%3Abug&label=bugs)](https://github.com/cthlbrennan/herdhub/issues?q=is%3Aissue+is%3Aclosed+label%3Abug)

All previously closed/fixed bugs can be tracked [here](https://github.com/cthlbrennan/herdhub/issues?q=is%3Aissue+is%3Aclosed).

| Bug | Status |
| --- | --- |
| [JS Uncaught ReferenceError: `foobar` is undefined/not defined](https://github.com/cthlbrennan/herdhub/issues/1) | Closed |
| [Python `'ModuleNotFoundError'` when trying to import module from imported package](https://github.com/cthlbrennan/herdhub/issues/2) | Closed |
| [Django `TemplateDoesNotExist` at /appname/path appname/template_name.html](https://github.com/cthlbrennan/herdhub/issues/3) | Closed |

**Open Issues**

[![GitHub issues](https://img.shields.io/github/issues/cthlbrennan/herdhub)](https://github.com/cthlbrennan/herdhub/issues)
[![GitHub closed issues](https://img.shields.io/github/issues-closed/cthlbrennan/herdhub)](https://github.com/cthlbrennan/herdhub/issues?q=is%3Aissue+is%3Aclosed)

Any remaining open issues can be tracked [here](https://github.com/cthlbrennan/herdhub/issues).

| Bug | Status |
| --- | --- |
| [JS `'let'` or `'const'` or `'template literal syntax'` or `'arrow function syntax (=>)'` is available in ES6 (use `'esversion: 11'`) or Mozilla JS extensions (use moz).](https://github.com/cthlbrennan/herdhub/issues/4) | Open |
| [Python `E501 line too long` (93 > 79 characters)](https://github.com/cthlbrennan/herdhub/issues/5) | Open |
